...
const DATA = window.DOKPILOT_DATA = {
  ...
  servers:[
    ...
    { id:"edge", name:"edge", ip:"203.0.113.11", ssh:"root", dokploy:"v0.28.4", status:"healthy", region:"Helsinki · Hetzner",
  ...
  apps:{
    app_001:{ id:"app_001", name:"web-app", domain:"example.com", server:"main", stack:"Next.js 15", status:"running", last:"4h ago", builds:1,
    ...
    app_002:{ id:"app_002", name:"api-server", domain:"api.example.com", server:"main", stack:"Node + Express", status:"running", last:"14h ago", builds:0,
      env:["DATABASE_URL","JWT_SECRET","PORT","REDIS_URL","SMTP_HOST","SMTP_USER","SMTP_PASS","NODE_ENV"], db:"api-pg", autodeploy:true },
    app_003:{ id:"app_003", name:"landing-page", domain:"app.example.com", server:"main", stack:"Astro 4", status:"building", last:"54m ago", builds:3,
      env:["PUBLIC_PLAUSIBLE_DOMAIN","NODE_ENV"], db:null, autodeploy:true },
    app_004:{ id:"app_004", name:"docs-api", domain:"docs.example.dev", server:"edge", stack:"FastAPI · Python 3.12", status:"running", last:"2d ago", builds:0,
      env:["DATABASE_URL","SECRET_KEY","ALLOWED_HOSTS","SENTRY_DSN"], db:"docs-pg", autodeploy:false },
  ...
  activity:[
    {app:"web-app",server:"main",status:"success",rel:"2m ago",dur:"47s"},
    {app:"landing-page",server:"main",status:"building",rel:"5m ago",dur:"…"},
    {app:"docs-api",server:"edge",status:"success",rel:"1h ago",dur:"1m 12s"},
    {app:"metrics-collector",server:"edge",status:"error",rel:"9h ago",dur:"6s"},
    {app:"api-server",server:"main",status:"success",rel:"14h ago",dur:"52s"},
  ],
  domains:[
    {host:"example.com",app:"web-app",zone:"example.com",ssl:"active",proxied:true,ssl_exp:"82d",record:"A → 203.0.113.10"},
    {host:"api.example.com",app:"api-server",zone:"example.com",ssl:"active",proxied:false,ssl_exp:"61d",record:"A → 203.0.113.10"},
    {host:"app.example.com",app:"landing-page",zone:"example.com",ssl:"issuing",proxied:true,ssl_exp:"—",record:"A → 203.0.113.10"},
    {host:"docs.example.dev",app:"docs-api",zone:"example.dev",ssl:"active",proxied:true,ssl_exp:"44d",record:"A → 203.0.113.11"},
  ],
  databases:[
    {id:"api-pg",name:"api-pg",engine:"PostgreSQL 16",server:"main",status:"running",size:"312 MB",app:"api-server",conns:"4 / 100"},
    {id:"docs-pg",name:"docs-pg",engine:"PostgreSQL 15",server:"edge",status:"running",size:"1.8 GB",app:"docs-api",conns:"11 / 100"},
    {id:"api-redis",name:"api-redis",engine:"Redis 7",server:"main",status:"running",size:"42 MB",app:"api-server",conns:"2 / 50"},
  ],
  job:{ id:"job_a1b2c3", repo:"github.com/your-name/your-app", branch:"main", server:"main", domain:"app.example.com",
    stack:"Next.js 15 · pnpm · Node 20",
    log:[
      {t:"12:34:02",kind:"info",text:"Cloning github.com/your-name/your-app (branch: main)…"},
    ...
    questions:[
      {id:"q1",label:"NEXT_PUBLIC_API_URL",type:"text",ph:"https://api.example.com",hint:"Build-time public API endpoint"},
